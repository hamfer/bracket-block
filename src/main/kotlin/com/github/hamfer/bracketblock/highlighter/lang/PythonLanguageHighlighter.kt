...
class PythonLanguageHighlighter : LanguageHighlighter {
    override fun id(): String = "Python"
    override fun displayName(): String = "Python"

    // Indent-scope via PSI (statement/suite), also include arg lists and dict/list literals for brackets
    private val classNames = listOf(
        "com.jetbrains.python.psi.PyStatementList",
        "com.jetbrains.python.psi.PyArgumentList",
        "com.jetbrains.python.psi.PyParenthesizedExpression",
        "com.jetbrains.python.psi.PyListLiteralExpression",
        "com.jetbrains.python.psi.PyDictLiteralExpression"
    )
