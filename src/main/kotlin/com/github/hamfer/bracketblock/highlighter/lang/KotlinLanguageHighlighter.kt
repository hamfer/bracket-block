...
class KotlinLanguageHighlighter : LanguageHighlighter {
    override fun id(): String = "kotlin"
    override fun displayName(): String = "Kotlin"
    ...
    private val classNames = listOf(
        ...
        "org.jetbrains.kotlin.psi.KtParameterList"
    )
