...
class JavaLanguageHighlighter : LanguageHighlighter {
    override fun id(): String = "JAVA"
    override fun displayName(): String = "Java"

    // Resolve classes lazily to avoid hard dependency if Java PSI changes
    ...
    private fun findElementSafely(file: PsiFile, offset: Int): PsiElement? {
        val safe = offset.coerceIn(0, maxOf(0, file.textLength))
