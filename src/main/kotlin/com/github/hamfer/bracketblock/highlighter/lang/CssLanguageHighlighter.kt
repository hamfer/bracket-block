...
class CssLanguageHighlighter : LanguageHighlighter {
    override fun id(): String = "CSS"
    override fun displayName(): String = "CSS"

    private val classNames = listOf(
        // Common CSS PSI elements across IDE builds
        "com.intellij.psi.css.CssRuleset",
        "com.intellij.psi.css.CssDeclarationBlock",
        "com.intellij.psi.css.CssMedia",
        "com.intellij.psi.css.CssPage"
    )
